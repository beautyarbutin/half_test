"""Multi-head self-attention example implemented without einops.
...
class MultiHeadSelfAttention(nn.Module):
    """Small educational MHA module using only native PyTorch tensor ops."""
...
def run_demo() -> None:
    ...
    print("Multi-head self-attention without einops")
